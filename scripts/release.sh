...
echo ""
echo "  Install on target machines (download from release, no build deps):"
echo "    Grab the matching tarball from the release page, extract, then"
echo "    use scripts/gen_config.sh to produce hub.json / agent.toml."
echo "    See scripts/README.md for the full flow."
echo ""
